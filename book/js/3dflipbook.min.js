       ...
       function props() {
           var style = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "volume",
               def = {
                   ...
                   preloadPages: 5,
                   rtl: !1,
                   sheet: { startVelocity: 1.1, cornerDeviation: 0.25, flexibility: 10, flexibleCorner: 0.5, bending: 11, wave: 0.5, shape: 0, widthTexels: 1050, heightTexels: 1485, color: 16777215, side: "color" },
                   cover: { binderTexture: "", depth: 3e-4, padding: 0, mass: 0.001 },
           ...
           return (
               {
                   volume: def,
                   flat: _extends({}, def, { sheet: _extends({}, def.sheet, { wave: 0.05, side: "transparent" }), cover: _extends({}, def.cover, { depth: 2e-5 }), page: _extends({}, def.page, { depth: 1e-5 }) }),
       ...
       var Pdf = (function () {
           ...
           return (
               (Pdf.prototype.init = function (handler, pages) {
                   (this.handler = handler), (this.doubledPages = !!pages && Math.abs(2 * Pdf.getPageSize(pages[0]).width - Pdf.getPageSize(pages[1]).width) / Pdf.getPageSize(pages[0]).width < 0.01);
                           ...
                           ? ((scene.loadingCtrl = new _LoadingController2.default(scene.view, !0, function (progress) {
                             ...
                             options.pdf
                                 ? ((scene.propsBuilder = new _PdfBookPropsBuilder2.default(options.pdf, scene.bookBuilder, options.bookStyle)),
                                   ...
                                   options.error && scene.propsBuilder.pdf.setErrorHandler(options.error))
           ...
           AutoNavigator = (function () {
               function AutoNavigator(context, bookCtrl) {
                   ...
                   _classCallCheck(this, AutoNavigator),
                       (props = _extends({}, props, { urlParam: props.urlParam || "fb3d-page", navigates: void 0 === props.navigates ? 1 : props.navigates, pageN: props.pageN || 0 })),
                       (this.props = props),
                       (this.context = context),
           ...
           Book = (function (_THREE$EventDispatche) {
               function Book(visual, sheets, pageCallback, props) {
                   ...
                   return (
                       ...
                       (_this.p = _extends({}, _this.prepareProps(props), { sheets: sheets, pageCallback: pageCallback, zoom: 1, singlePage: !1, autoResolution: { enable: !1, k: 1.5 } })),
               ...
               return (
                               ...
                               if (this.hoverInfo && void 0 !== this.hoverInfo.pendings) ++this.hoverInfo.pendings;
                                   ...
                                   res.then(function (block) {
                                       if ((_this4.hoverInfo && _this4.hoverInfo.pendings < 1 && ((block = void 0), delete _this4.hoverInfo), block)) {
                                           ...
                                           (block.force = _this4.sheetPhysics.getTargetForceClb(p.mass * block.getSize(), i ? Math.PI - 0.02 : 0.02)),
                                               (block.cornerForce = function () {
                                                   return (i ? -1 : 1) * _SheetPhysics2.default.hoverCornerForceClb();
                                               }),
                                               _this4.sheetPhysics.setParametr(block.physicId, "angle", i ? Math.PI - 0.01 : 0.01),
                   ...
                   (Book.prototype.connectPhysics = function (block, mass, angle, velocity, flexibility, coverHeight, simulateClb, removeClb, progressClb) {
                       ...
                       return (this.sheetPhysics.getSize() ? Promise.resolve() : this.notifyBeforeAnimation())
                           .then(function () {
                               return (
                   ...
                   (Book.prototype.calcProps = function (props) {
                       ...
                       return (
                           ...
                           _extends({}, p, { scale: 10, height: height, width: width, flipProgressClb: flipProgressClb, cover: cover, page: page, marker: marker })
                       );
                   }),
                   ...
                   (Book.prototype.cssLayerJsObjectInit = function (c, p) {
                       ...
                       return (
                           ...
                           {
                               hide: function () {
                                   _this10.pendingPlayers.length && ((_this10.pendingPlayers = []), _this10.dispatchEvent({ type: "pendingPlayers" })),
               ...
               return (
                   ...
                   (BookController.prototype.updateViewState = function () {
                       this.viewState = {
                           ...
                           cmdDefaultZoom: { enable: this.canDefaultZoom(), visible: this.isCmdVisible("cmdDefaultZoom"), active: this.canDefaultZoom() && Math.abs(this.bookWatcher.scale - this.p.scale.default) < this.p.eps },
                           ...
                           cmdSinglePage: { enable: !0, visible: this.isCmdVisible("cmdSinglePage"), active: this.state.singlePage },
                           ...
                           touchCmdZoom: {
                               activate: function (e, data) {
                                   if (!isSwipping("touchCmdZoom")) {
                                       ...
                                       "start" === data.state
                                           ? (_this7.touchZoomData = { l: l(data), scale: _this7.bookWatcher.scale })
                               ...
                               activate: function (e, data) {
                                   if (isSwipping("touchCmdSwipe"))
                                       if ("start" === data.state) {
                                           ...
                                           "move" === data.state
                                               ? (e.preventDefault(),
                                                 _this7.swipeData.handled ||
                                                     ((_this7.swipeData = _extends({}, _this7.swipeData, { x: _this7.swipeData.x + data.dx, y: _this7.swipeData.y + data.dy })),
                                                     Math.abs(_this7.swipeData.x0 - _this7.swipeData.x) > 100 && (_this7.swipeData.x0 > _this7.swipeData.x ? _this7.cmdForward() : _this7.cmdBackward(), (_this7.swipeData.handled = !0))))
                       ...
                       if ((delete this.canceled, "pdf" === this.type)) {
                           ...
                           this.useIFrame()
                               ? ((callManually = !!this.frame),
                                 this.frame || (this.frame = (0, _libs.$)('<iframe src="' + this.pdfSrc + '" style="display: none;"></iframe>').appendTo(this.doc.body)),
       ...
       var _BookPropsBuilder2 = __webpack_require__(9),
           ...
           ClbBookPropsBuilder = (function (_BookPropsBuilder) {
               function ClbBookPropsBuilder(context, pageCallback, pages, onReady, style) {
                   ...
                   if ((_this.calcSheets(pages), (_this.pageCallback = pageCallback), (_this.binds = { pageCallback: pageCallback.bind(_this) }), (_this.imageFactory = new _ImageFactory2.default(context)), pages > 0)) {
           ...
           PageManager = (function () {
               function PageManager(visual, book, p) {
                   ...
                   (this.nextCanvas = 0),
                       ...
                       visual.addObject(new _libs.THREE.Mesh(new _libs.THREE.PlaneGeometry(0.001, 0.001), this.tmpMaterial)),
                   ...
                   (SearchEngine.prototype.process = function () {
                       ...
                       if (this.update) {
                           ...
                           this.find(this.pageCallback(this.page)).then(function (contexts) {
                               stamp === _this.stamp &&
                                   (contexts.length && _this.results.push({ page: _this.page, contexts: contexts }), _this.onPageHitsChanged && _this.onPageHitsChanged(_this.page, _this.query), ++_this.page, _this.process());
                           });
                       }
                   }),
       ...
       var EventsToActions = (function () {
           ...
           return (
               ...
               (EventsToActions.prototype.touchPick = function (e, flags, touches) {
                   ...
                   (this.touchPicked = _extends({}, pos, { actions: this.getActions("touchdrag", touches.length, flags), code: touches.length, flags: flags })),
           ...
           PdfImage = (function (_ImageBase) {
               ...
               return (
                   ...
                   (PdfImage.prototype.render = function (handler) {
                       var _this5 = this;
                       this.page
                           ? this.page.render({ canvasContext: this.pushCtx(), viewport: this.viewport }).promise.then(function () {
               ...
               function View(parentContainer, onLoad) {
                   ...
                   "function" == typeof template
                       ...
                       : ((links = template.links || this.getTemplate().links),
                         ...
                         (files = {})),
                       templateName && this.container.addClass(templateName),
           ...
           VisualWorld = (function (_THREE$EventDispatche) {
               function VisualWorld(wnd, doc, container) {
                   ...
                   (_this.camera.position.x = 0),
                       ...
                       (_this.renderer = new _libs.THREE.WebGLRenderer({ alpha: !0, precision: VisualWorld.getPrecision(), antialias: !0 })),
